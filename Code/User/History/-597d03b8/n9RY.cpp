...
void tuneGeneration(ufo::map::OccupancyMapColor const &map, bool occupied_space, bool free_space,
                    bool unknown_space, float given_x, float given_y, float given_z, ufo::map::DepthType min_depth = PLANNING_DEPTH)
{
  highest_x = -9999;
  highest_y = -9999;
  highest_z = -9999;
